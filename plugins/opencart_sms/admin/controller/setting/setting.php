...
class ControllerSettingSetting extends Controller
{
	...
	public function index()
	{
		...
		if (isset($this->request->post['config_appid'])) {
			$data['config_appid'] = $this->request->post['config_appid'];
		} else {
			$data['config_appid'] = $this->config->get('config_appid');
		}

		if (isset($this->request->post['config_appkey'])) {
			$data['config_appkey'] = $this->request->post['config_appkey'];
		} else {
			$data['config_appkey'] = $this->config->get('config_appkey');
		}

		if (isset($this->request->post['config_sign'])) {
			$data['config_sign'] = $this->request->post['config_sign'];
		} else {
			$data['config_sign'] = $this->config->get('config_sign');
		}
