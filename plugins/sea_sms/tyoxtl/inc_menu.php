...
$menu=array (
	...
	'content'=>array (
		...
		10=>"<a target='I2' href='admin_video.php?v_recycled=ok'>隐藏数据</a>",
		11=>"<a target='I2' href='admin_video.php?v_ispsd=ok'>有密码数据</a>",
		12=>"<a target='I2' href='admin_video.php?v_ismoney=ok'>消费点数据</a>",	
	...
	'make'=>array (
		...
		7=>"",
		8=>"<a target='I2' href='admin_cron.php'>定时任务自动版</a>",
		9=>"<a target='I2' href='admin_auto.php'>定时任务挂机版</a>",
	),
	'user'=>array (
		...
		5=>"<a target='I2' href='admin_notify.php'>会员消息通知</a>",
	),
	'tool'=>array (
	...
	'system'=>array (
		...
		17=>"<a target='I2' href='admin_sms.php'>短信设置</a>",
	),
);
$menuedit=array(
	'editor'=>array(
